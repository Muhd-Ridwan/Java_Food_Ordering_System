...
//        this.vendorId = "VD004";
    ...
    private void ManageOrderBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ManageOrderBtnActionPerformed
        OrderStatusVendor OSV = new OrderStatusVendor(this.vendorId);
        OSV.setVisible(true);
        this.setVisible(false);
    ...
    private void OrderHistoryBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OrderHistoryBtnActionPerformed
        OrderHistoryVendor OHV = new OrderHistoryVendor(this.vendorId);
        OHV.setVisible(true);
        this.setVisible(false);
    ...
    private void CustomerReviewBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CustomerReviewBtnActionPerformed
        VendorReadReview VRR = new VendorReadReview(this.vendorId);
        VRR.setVisible(true);
        this.setVisible(false);
    ...
    private void RevenueBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RevenueBtnActionPerformed
        RevenueDashboardVendor RDV = new RevenueDashboardVendor(this.vendorId);
        RDV.setVisible(true);
        this.setVisible(false);
